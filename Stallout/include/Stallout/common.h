...
#ifdef _ST_OS_WINDOWS
	#define _ST_BREAK __debugbreak()
#elif defined (__GNUC__)
	#define _ST_BREAK __builtin_trap()
#else
	#define _ST_BREAK signal(SIGTRAP)
#endif
...
using Underlying##EnumType = std::underlying_type_t<EnumType>;                  \
inline EnumType operator|(EnumType lhs, EnumType rhs) {                   \
    return static_cast<EnumType>(                                         \
        static_cast<Underlying##EnumType>(lhs) | static_cast<Underlying##EnumType>(rhs));     \
}                                                                        \
                                                                         \
inline EnumType& operator|=(EnumType& lhs, EnumType rhs) {                \
    lhs = lhs | rhs;                                                      \
...
inline EnumType operator|(EnumType lhs, Underlying##EnumType rhs) {                   \
    return static_cast<EnumType>(                                         \
        static_cast<Underlying##EnumType>(lhs) | static_cast<Underlying##EnumType>(rhs));     \
}                                                                        \
                                                                         \
